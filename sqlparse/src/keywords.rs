...
const KEYWORDS: [&str; 612] = [
    "SELECT" , "INSERT" , "DELETE" , "UPDATE" , "UPSERT" , "REPLACE" ,  "MERGE" , "DROP" , "CREATE" , "ALTER",
    ...
    "YEAR",
    "ZONE",
    "ARRAY" , "BIGINT" , "BINARY" , "BIT" , "BLOB" , "BOOLEAN" , "CHAR" , "DATE" , "DEC" , "DECIMAL" , "FILE_TYPE" , "FLOAT" , "INT" , "INT8" , "INTEGER" , "INTERVAL" , "LONG" , "NATURALN" , "NVARCHAR" , "NUMBER" , "NUMERIC" , "PLS_INTEGER" , "POSITIVE" , "POSITIVEN" , "REAL" , "ROWID" , "ROWLABEL",
...
pub fn init_trie() -> Trie {
    ...
    for keyword in KEYWORDS { t.insert(keyword) }
    t
}
