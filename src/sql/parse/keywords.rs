...
pub fn is_keyword(k: &str) -> TokenType {
    ...
    match keyword.as_ref() {
        ...
        // KEYWORDS
        "ABORT" | "ABS" | "ABSOLUTE" | "ACCESS" | "ADA" | "ADD" | "ADMIN" | "AFTER" | "AGGREGATE" | "ALIAS" | "ALL" | "ALLOCATE" | "ANALYSE" | "ANALYZE" | "ANY" | "ARRAYLEN" | "ARE" | "ASC" | "ASENSITIVE" | "ASSERTION" | "ASSIGNMENT" | "ASYMMETRIC" | "AT" | "ATOMIC" | "AUDIT" | "AUTHORIZATION" | "AUTO_INCREMENT" | "AVG" => TokenType::Keyword,
        ...
        "CLOB" | "CLOSE" | "CLUSTER" | "COALESCE" | "COBOL" | "COLLATE" | "COLLATION" | "COLLATION_CATALOG" | "COLLATION_NAME" | "COLLATION_SCHEMA" | "COLLECT" | "COLUMN" | "COLUMN_NAME" | "COMPRESS" | "COMMAND_FUNCTION" | "COMMAND_FUNCTION_CODE" | "COMMENT" | "COMMIT" | "COMMITTED" | "COMPLETION" => TokenType::Keyword,
        ...
        "DELIMITERS" | "DEREF" | "DESC" | "DESCRIBE" | "DESCRIPTOR" | "DESTROY" | "DESTRUCTOR" | "DETERMINISTIC" | "DIAGNOSTICS" | "DICTIONARY" | "DISABLE" | "DISCONNECT" | "DISPATCH" | "DO" | "DOMAIN" | "DYNAMIC" | "DYNAMIC_FUNCTION" | "DYNAMIC_FUNCTION_CODE" => TokenType::Keyword,
